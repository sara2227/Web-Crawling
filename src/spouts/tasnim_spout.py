...
class WordSpout(Spout):
    ...
    def initialize(self, stormconf, context):
        self.in_path = '/home/tookai-1/Documents/HodHod/crawler/streamparse/websites/csv_files/tasnim.csv'
        self.url_pd = pd.read_csv(self.in_path,skiprows=[i for i in range(1,12902)])
